<?php
	...
	if($id != 0){
		...
		$listaProductos = productoDAO::ObtenerTodosLosProductosPorCat($producto->IdCategoria, "NombreProducto_asc");
	}
?>
<!DOCTYPE html>
<html lang="zxx">
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-pic-zoom">
						<img class="product-big-img" src="/divisima/<?php echo $producto->DireccionFoto;?>" alt="">
					</div>
				...
				<div class="col-lg-6 product-details">
					<h2 class="p-title"><?php echo $producto->NombreProducto;?></h2>
					<h3 class="p-price"><?php echo $producto->Precio;?></h3>
					<h4 class="p-stock">Disponibilidad: <span>Hay Stock</span></h4>
					<div class="p-rating">
					...
					<div class="p-review">
						<a href="">3 reseñas</a>|<a href="">Añadir reseñas</a>
					</div>
					<div class="quantity">
						<p>Cantidad</p>
